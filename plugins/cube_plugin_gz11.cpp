    ...
    class CubePlugin : public ModelPlugin
    {
      ...
      public: CubePlugin() {}
        ...
        void setPosition(const std_msgs::Float32MultiArray::ConstPtr& msg)
        {
          ...
          if (msg->data.size() == 7) {
            ignition::math::Vector3<double> position = ignition::math::Vector3<double>(msg->data[0], msg->data[1], msg->data[2]);
            ignition::math::Quaternion<double> orientation = ignition::math::Quaternion<double>(msg->data[3], msg->data[4], msg->data[5], msg->data[6]);
            ignition::math::Pose3<double> pose = ignition::math::Pose3<double>(position, orientation);
